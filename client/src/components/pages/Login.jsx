...
function Login({ className, ...props}) {
  const [loginData, setLoginData] = useState({email_phone:"", password:""})
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground text-balance">
                  Login to your AI-POWERED VOTING SYSTEM account
                </p>
              </div>
              <div className="grid gap-3">
                <Label htmlFor="email">Email</Label>
                <Input id="email" type="email" name="email_phone" value={loginData.email_phone}  placeholder="john@example.com" required
                onChange={(e)=> setLoginData((prev) => ({...prev, email_phone:e.target.value}))}/>
              </div>
              <div className="grid gap-3">
