  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Voter Registration Approvals</h1>
          <p className="text-gray-600">Review and approve pending voter registration requests</p>
        </div>
